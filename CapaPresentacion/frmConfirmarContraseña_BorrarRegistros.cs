...
{
    public partial class frmConfirmarContraseña_BorrarRegistros : Form
    {
        ...
        public frmConfirmarContraseña_BorrarRegistros()
        {
            InitializeComponent();
        }
                ...
                try
                {
                    ...
                    if (count == 1)
                    {
                        ...
                        try
                        {
                            ...
                            //string str1 = string.Format("DELETE");
                            //SqlCommand cmd1 = new SqlCommand(str1, conexion);

                            //cmd1.ExecuteNonQuery();

                            //MessageBox.Show("El registro se ha eliminado definitivamente");
                            //conexion.Close();
        ...
        private void frmConfirmarContraseña_BorrarRegistros_Load(object sender, EventArgs e)
        {
