...
namespace CapaPresentacion
{
    public partial class frmServicios : Form
    {
        ...
        private void OperacionInsertarServicio()
        {
            ...
            SqlCmd2.Parameters.AddWithValue("@d1", DateTime.Now.ToString());
            SqlCmd2.Parameters.AddWithValue("@d2", "El usuario ha Registrado a un servicio.");
        ...
        private void OperacionEditarServicio()
        {
            ...
            SqlCmd2.Parameters.AddWithValue("@d1", DateTime.Now.ToString());
            SqlCmd2.Parameters.AddWithValue("@d2", "El usuario ha editado un servicio.");
            SqlCmd2.Parameters.AddWithValue("@d3", Session_Actual.Log);
        ...
        private void OperacionAnularServicio()
        {
            ...
            SqlCmd2.Parameters.AddWithValue("@d1", DateTime.Now.ToString());
            SqlCmd2.Parameters.AddWithValue("@d2", "El usuario ha Anulado un servicio.");
            SqlCmd2.Parameters.AddWithValue("@d3", Session_Actual.Log);
