namespace CapaPresentacion.Reportes
{
    partial class frmReporteEstudios
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.estudiosTableAdapter = new CapaPresentacion.dsPrincipalTableAdapters.EstudiosTableAdapter();
            ...
            reportDataSource1.Name = "dsEstudios";
            reportDataSource1.Value = this.estudiosBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "CapaPresentacion.Reportes.rptEstudios.rdlc";
            ...
            this.estudiosBindingSource.DataSource = this.dsPrincipal;
            // 
        ...
        private dsPrincipalTableAdapters.EstudiosTableAdapter estudiosTableAdapter;
    }
}